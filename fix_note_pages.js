...
// ── New Note Page ─────────────────────────────────────────────────────────
fs.mkdirSync('src/app/notes/new', { recursive: true });
      ...
      <main className="p-6 md:p-8 max-w-3xl mx-auto">
        <div className="flex items-center gap-4 mb-8 animate-fade-up">
          ...
          <div>
            ...
            <p className="text-white/40 text-sm mt-0.5">AI ile otomatik ozet</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 animate-fade-up">
          ...
          <div>
            ...
            <textarea id="note-content" value={form.content}
              ...
              placeholder="Ozetlemek istediginiz metni buraya girin..." required />
          </div>
          ...
          <div className="glass rounded-xl p-4 flex items-start gap-3 border border-indigo-500/20">
            ...
            <p className="text-white/50 text-xs leading-relaxed">
              Not kaydedildikten sonra AI otomatik olarak kisa ozet, onemli noktalar ve anahtar kelimeleri cikartacak.
              Turkce ve Ingilizce metinler desteklenmektedir.
            </p>
          </div>
          ...
          <button id="create-note-btn" type="submit" disabled={loading}
            ...
            {loading
              ...
              : <><Sparkles className="w-5 h-5" /><span>AI ile Ozetle ve Kaydet</span></>}
          </button>
        </form>
      </main>
    </div>
...
// ── Note Detail Page ───────────────────────────────────────────────────────
fs.mkdirSync('src/app/notes/[id]', { recursive: true });
fs.writeFileSync('src/app/notes/[id]/page.tsx', `'use client'
...
console.log('Note pages written!');
